...
public class ConsultarProductoGui extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btnBuscar) {
			...
			if (confirmacion.equals("Producto Actualizada")) {
				
				JOptionPane.showMessageDialog(null, " Producto modificada con exito ","Confirmación",JOptionPane.INFORMATION_MESSAGE);	
			} else{
